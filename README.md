...
[![Courses](https://img.shields.io/badge/courses-10-blue)](software/docs/COURSE_CATALOG.md)
[![Modules](https://img.shields.io/badge/modules-320-green)](software/docs/MODULES.md)
[![Formats](https://img.shields.io/badge/output_formats-6-orange)](software/docs/QUICKSTART.md)
[![Tests](https://img.shields.io/badge/tests-1020_passing-brightgreen)](software/docs/TESTING.md)
[![License](https://img.shields.io/badge/license-CC--BY--4.0-lightgrey)](#license)

> **Minimize surprise. Maximize evidence.**

Welcome to the open-source curriculum infrastructure for **Active Inference education**. This repository hosts **10 complete courses** spanning Kindergarten to PhD, powered by a modular **Python publishing engine**.
...
- **[CLI Reference](software/docs/CLI_REFERENCE.md)**: Documentation for all 21 CLI scripts.
...
3. specific guidelines for **[Content Authoring](software/docs/CONTENT_AUTHORING.md)**.

### Testing

We maintain a robust suite of **1,020+ tests** ensuring curriculum integrity and software stability.
...
---
*Generated by the Active Inference Institute Publishing Pipeline.*
