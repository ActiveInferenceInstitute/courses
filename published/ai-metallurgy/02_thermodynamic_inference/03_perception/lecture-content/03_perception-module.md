# Thermal Analysis and Calorimetric Sensing

## Introduction

This module explores **Perception** within the context of **Thermodynamic Inference**. In the Active Inference framework, perception plays a critical role in how systems maintain their identity, process information, and adapt to perturbation. Here we examine this through the lens of phase equilibria, transformation kinetics, and calphad.

**Key themes**: DSC, DTA, dilatometry — sensing phase transitions through thermal signatures
...
2. Identify how perception manifests in phase equilibria, transformation kinetics, and calphad
...
In Active Inference, perception refers to the process by which systems maintain and update their relationship with the environment. For metallurgical systems, this maps directly onto physical processes: DSC, DTA, dilatometry — sensing phase transitions through thermal signatures.
...
|---------|----------------------|
| Perception | DSC, DTA, dilatometry — sensing phase transitions through thermal signatures |
