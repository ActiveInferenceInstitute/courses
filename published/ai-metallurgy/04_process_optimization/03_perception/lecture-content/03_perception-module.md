# In-Situ Monitoring and Non-Destructive Testing

## Introduction

This module explores **Perception** within the context of **Process Optimization**. In the Active Inference framework, perception plays a critical role in how systems maintain their identity, process information, and adapt to perturbation. Here we examine this through the lens of heat treatment, welding, additive manufacturing, industry 4.0.

**Key themes**: In-situ XRD, infrared monitoring, ultrasonic testing, eddy current — real-time sensing
...
2. Identify how perception manifests in heat treatment, welding, additive manufacturing, industry 4.0
...
In Active Inference, perception refers to the process by which systems maintain and update their relationship with the environment. For metallurgical systems, this maps directly onto physical processes: In-situ XRD, infrared monitoring, ultrasonic testing, eddy current — real-time sensing.
...
In Al-Cu precipitation-hardening alloys (such as 2024-T3), perception operates through the sequence of metastable precipitate formation: GP zones -> theta'' -> theta' -> theta (Al2Cu). Each stage represents the system's ongoing inference about its equilibrium state.
...
|---------|----------------------|
| Perception | In-situ XRD, infrared monitoring, ultrasonic testing, eddy current — real-time sensing |
