#!/usr/bin/env bash
# Audit script for Active Inference for Families
...
echo "=== Active Inference for Families Audit ==="
echo ""
...
check_course "01_growing_together" "Growing Together"
check_course "02_tiny_bodies_big_brains" "Tiny Bodies, Big Brains"
check_course "03_patterns_in_play" "Patterns in Play"
check_course "04_screens_toys_tools" "Screens, Toys & Tools"
