#!/usr/bin/env bash
# Audit script for Active Inference for Elementary School
...
echo "=== Active Inference for Elementary School Audit ==="
echo ""
...
check_course "01_story_time" "Story Time"
check_course "02_our_bodies" "Our Bodies"
check_course "03_counting_patterns" "Counting & Patterns"
check_course "04_robots_helpers" "Robots & Helpers"
