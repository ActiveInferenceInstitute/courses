...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Making Things Happen) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Making Things Happen |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Describe** how actions change the world
2. **Identify** actions that explore
3. **Identify** actions that help
