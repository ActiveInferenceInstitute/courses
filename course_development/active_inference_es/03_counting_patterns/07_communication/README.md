...
Part of **Counting & Patterns**.

## Contents

| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Talking, Sharing, Helping) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Talking, Sharing, Helping |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Identify** ways we communicate
2. **Explain** why sharing helps
3. **Describe** teamwork as communication
