...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Open Problems and Research Frontiers) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Open Problems and Research Frontiers |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Identify** open mathematical problems
2. **Critically** evaluate FEP scope claims
3. **Design** a novel research proposal
