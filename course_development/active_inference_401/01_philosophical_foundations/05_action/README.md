...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Path Integrals and Optimal Control) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Path Integrals and Optimal Control |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Derive** path integral formulations
2. **Connect** KL control to active inference
3. **Analyze** continuous-time active inference
