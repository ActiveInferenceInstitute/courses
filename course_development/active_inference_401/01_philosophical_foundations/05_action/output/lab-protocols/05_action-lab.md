# Lab: Pragmatism and the Primacy of Practice

> **Learning Goal:** Apply pragmatist philosophy to Active Inference's account of action.

## Part 1: Pragmatist Mapping

**Exercise**: Complete the mapping and evaluate each:

| Pragmatist Concept | Active Inference Analog | Evaluation |
|-------------------|------------------------|------------|
| Peirce: Doubt triggers inquiry | Prediction error triggers inference | |
| James: Truth = what works | Model evidence = predictive success | |
...
## Part 2: Affordance Analysis

> **Learning Goal:** Apply affordance theory through Active Inference formalization.

**Exercise**: Analyze the affordances of a simple object (e.g., a chair) for different agents:

| Agent | Affordance of a Chair | EFE Analysis (why this affordance?) |
|-------|----------------------|-------------------------------------|
| Human adult | Sitting (reduces physical fatigue PE) | |
...
## Part 3: Skill Acquisition Diary

> **Learning Goal:** Apply Dreyfus's expertise model through Active Inference.
