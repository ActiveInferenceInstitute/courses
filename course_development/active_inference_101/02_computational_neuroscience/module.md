# Module 02: Agents in 101

## Learning Objectives

1.  Define **Agents** within the context of 101.
2.  Analyze how Agents interacts with other components of the Active Inference framework.
3.  Apply specific constraints of 101 to the formal definition of Agents.

## Introduction

This module explores **Agents**. In the **101** curriculum, we approach this topic with a focus on specific applications and theoretical depth appropriate for the audience. Agents is a critical component of the 8-part Active Inference spine, bridging the gap between [Previous Topic] and [Next Topic].
...
In 101, we see Agents manifest in:
