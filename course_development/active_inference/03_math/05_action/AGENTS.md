...
| `module.md` | File | Full lecture: Expected Free Energy (G): Risk and Ambiguity Decomposition |
| `questions.md` | File | 20 study questions |
| `practice_quiz.md` | File | Quiz: 7 MC + 3 FR (Action) |
| `lab.md` | File | Derivation: Expected Free Energy (G): Risk and Ambiguity Decomposition |
...
- **Topic**: Action — Expected Free Energy (G): Risk and Ambiguity Decomposition
