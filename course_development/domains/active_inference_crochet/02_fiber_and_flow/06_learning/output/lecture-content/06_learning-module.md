...
Successful substitution requires the crocheter to model multiple properties simultaneously:
- **Weight**: Will the substitute yarn produce a similar gauge?
- **Fiber**: Will it have similar drape, warmth, and care properties?
- **Texture**: Will the stitch pattern show similarly?
- **Color behavior**: Will it pool, stripe, or solid in a similar way?
...
Over years of practice, crocheters accumulate a **mental library** — an extensive collection of material models organized by fiber type, weight, brand, texture, and experience. This library functions as a prior in the Bayesian sense: when encountering a new yarn, the crocheter does not start from zero. They start from their closest existing model and update from there.
...
- **Previous Module**: [Action — Pulling Through, Letting Go](../05_action/module.md)
- **Next Module**: [Communication — The Language of Fiber and Color](../07_communication/module.md)
