...
<div style="border: 1px solid #ccc; border-radius: 4px; min-height: 96px; padding: 8px; margin: 8px 0; background-color: #fafafa;"><em style="color: #999; font-size: 0.85em;">Write your response here</em></div>
(What does the body know that words cannot capture? How does breath, heartbeat, embodied being reveal the nature of embodied learning?)
...
| Breath, heartbeat, embodied being lens | <span style="border-bottom: 1px solid #999; display: inline-block; min-width: 200px;">&nbsp;</span> | Course-specific perspective on learning |
