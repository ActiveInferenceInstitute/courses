...
1. **Experience** cognition as inseparable from the body through pattern-feeling without numbers
...
- **Pattern-feeling without numbers**: The specific lens this course brings to cognition
...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (The Body Thinks Too) |
