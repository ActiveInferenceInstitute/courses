#!/usr/bin/env bash
# Audit script for Active Inference: Embodied Experience
...
echo "=== Active Inference: Embodied Experience Audit ==="
echo ""
...
check_course "01_felt_sense" "Felt Sense"
check_course "02_living_presence" "Living Presence"
check_course "03_intuitive_knowing" "Intuitive Knowing"
check_course "04_moving_through_world" "Moving Through the World"
