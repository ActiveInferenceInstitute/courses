...
EFE = **Pragmatic value** (will this achieve our goals?) + **Epistemic value** (will this reduce our uncertainty?)
...
- For team coordination and collective action, see [Collective Intelligence: Action](../../02_collective_intelligence/05_action/module.md)
- For policy selection and strategic options, see [Strategic Modeling: Action](../../03_strategic_modeling/05_action/module.md)
