...
These shared resources serve as the single source of truth for terminology, notation, and references across all courses in Active Inference for Organizations.
