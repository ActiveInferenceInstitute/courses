#!/usr/bin/env bash
# Audit script for Active Inference for Metallurgy
set -euo pipefail
...
echo "=== Active Inference for Metallurgy Audit ==="
echo ""
...
check_course "01_metallurgical_systems" "Metallurgical Systems"
check_course "02_thermodynamic_inference" "Thermodynamic Inference"
check_course "03_microstructural_evolution" "Microstructural Evolution"
check_course "04_process_optimization" "Process Optimization"
