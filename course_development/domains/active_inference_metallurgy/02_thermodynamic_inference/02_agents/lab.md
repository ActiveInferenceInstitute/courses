# Lab: Exploring Agents in Thermodynamic Inference

## Objectives

> **Learning Goal:** Apply the Active Inference concept of agents to a concrete metallurgical scenario using calculation lab techniques.
...
## Part 2: Agents Analysis (25 min)

### 2A: Identify the Active Inference Components

Map your chosen system onto the Active Inference framework in the context of agents:
...
Describe how agents operates in your system:

- What is the driving force (free energy gradient)?
- What is the timescale?
- What characterization technique would you use to observe it?

{fill:textarea, placeholder: "Describe the dynamics of agents in your system"}

---

## Part 3: Quantitative Exercise (20 min)

Perform a simple calculation or simulation related to agents in your system:
...
1. How did the Active Inference framework change your understanding of agents in this system?
