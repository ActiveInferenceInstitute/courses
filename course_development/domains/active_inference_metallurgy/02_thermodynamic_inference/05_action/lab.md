# Lab: Exploring Action in Thermodynamic Inference

## Objectives

> **Learning Goal:** Apply the Active Inference concept of action to a concrete metallurgical scenario using calculation lab techniques.
...
## Part 2: Action Analysis (25 min)

### 2A: Identify the Active Inference Components

Map your chosen system onto the Active Inference framework in the context of action:
...
Describe how action operates in your system:

- What is the driving force (free energy gradient)?
- What is the timescale?
- What characterization technique would you use to observe it?

{fill:textarea, placeholder: "Describe the dynamics of action in your system"}

---

## Part 3: Quantitative Exercise (20 min)

Perform a simple calculation or simulation related to action in your system:
...
1. How did the Active Inference framework change your understanding of action in this system?
