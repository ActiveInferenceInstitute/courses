# Practice Quiz: Microstructural Evolution — Module 02: Agents
...
1. In the Active Inference framework, agents in a metallurgical system is best understood as:
...
3. In the context of agents, "prediction error" in a metallurgical system corresponds to:
...
4. Which characterization technique provides the highest precision for studying crystallographic agents?
...
2. You have two characterization methods for studying agents: optical microscopy (fast, low cost, limited resolution) and TEM (slow, expensive, atomic resolution). Using the concept of epistemic value and precision, explain how you would decide which to use for a given research question.
