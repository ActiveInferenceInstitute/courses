# Practice Quiz: Microstructural Evolution — Module 01: Systems
...
1. In the Active Inference framework, systems in a metallurgical system is best understood as:
...
3. In the context of systems, "prediction error" in a metallurgical system corresponds to:
...
4. Which characterization technique provides the highest precision for studying crystallographic systems?
...
2. You have two characterization methods for studying systems: optical microscopy (fast, low cost, limited resolution) and TEM (slow, expensive, atomic resolution). Using the concept of epistemic value and precision, explain how you would decide which to use for a given research question.
