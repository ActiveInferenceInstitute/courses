...
Remember:
- **Internal states**: Things within your invention/organization that you directly control
- **Sensory states**: Channels through which you receive information from the ecosystem
- **Active states**: Channels through which you influence the ecosystem
- **External states**: Factors that affect your invention but that you cannot directly control
...
Positive feedback loops (things that accelerate growth or decline):
1. 
<div style="border: 1px solid #ccc; border-radius: 4px; min-height: 96px; padding: 8px; margin: 8px 0; background-color: #fafafa;"><em style="color: #999; font-size: 0.85em;">Write your response here</em></div>
...
Negative feedback loops (things that stabilize the system):
1. 
<div style="border: 1px solid #ccc; border-radius: 4px; min-height: 96px; padding: 8px; margin: 8px 0; background-color: #fafafa;"><em style="color: #999; font-size: 0.85em;">Write your response here</em></div>
