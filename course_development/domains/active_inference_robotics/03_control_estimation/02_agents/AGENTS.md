# Station: Agents (Control & Estimation)
...
- **Topics**: observer design, separation principle, dual control, Active Inference equivalences
...
1. Present agents through rigorous mathematical formulations with explicit equations and derivations.
2. Show the formal relationship between classical agents approaches and Active Inference, including conditions under which they are equivalent.
3. Use standard control theory notation (A, B, C, D matrices; Q, R cost matrices) alongside Active Inference notation (F, G, mu, pi).
4. Include concrete numerical examples with specific robot parameters to make abstract agents concepts tangible.
