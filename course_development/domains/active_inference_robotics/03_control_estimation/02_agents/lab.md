# Lab: Estimator-Controller Agent Design

## Objective

Design an integrated estimator-controller agent using the separation principle and compare it with Active Inference's unified perception-action framework. You will implement a Luenberger observer paired with LQR control, then redesign the system as an Active Inference agent.
...
Formulate the agents problem mathematically:
...
1. Write the classical agents algorithm step-by-step.
