# Lab: Networked Control Systems

## Objective

Analyze the effects of communication constraints (delays, packet loss, bandwidth limits) on distributed control and estimation. You will design a networked control system with consensus-based state estimation and compare it with distributed Active Inference.
...
Formulate the communication problem mathematically:
...
1. Write the classical communication algorithm step-by-step.
