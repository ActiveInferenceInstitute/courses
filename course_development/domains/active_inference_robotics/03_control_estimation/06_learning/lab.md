# Lab: Adaptive Control and Parameter Estimation

## Objective

Design adaptive control systems that update their parameters online to track changing plant dynamics. You will compare model reference adaptive control (MRAC) with Active Inference parameter learning and analyze stability guarantees.
...
Formulate the learning problem mathematically:
...
1. Write the classical learning algorithm step-by-step.
