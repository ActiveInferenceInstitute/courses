...
| --- | --- | --- | --- |
| Sensors | Observation model | Likelihood mapping | {fill} |
| Actuators | Control input | Active states | {fill} |
| Controller | State estimator + planner | Free energy minimization | {fill} |
| World model | Dynamics model | Generative model | {fill} |
| Noise handling | Kalman gain | Precision weighting | {fill} |
