# Lab: Autonomous Perception Pipelines

## Objective

Design a complete autonomous perception pipeline that processes raw sensor data into semantic scene understanding. You will implement a multi-stage perception system (detection, tracking, classification, scene graph) and frame it as hierarchical variational inference.
...
Define the requirements for an autonomous perception system:
...
Design the core algorithms for the autonomous perception system:
...
2. Design integration tests for the complete perception pipeline.
3. Specify simulation-based testing scenarios.
4. Define metrics for evaluating autonomous perception performance.
