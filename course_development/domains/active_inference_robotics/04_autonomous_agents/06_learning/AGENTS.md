# Station: Learning (Autonomous Agents)
...
- **Topics**: reinforcement learning, imitation learning, skill primitives, curriculum learning, full autonomy requirements
...
1. Frame autonomous learning as a system that operates without human intervention, using Active Inference to handle uncertainty, novelty, and failures.
...
5. Connect theoretical Active Inference concepts to practical autonomous learning implementation with specific code patterns and architectural decisions.
