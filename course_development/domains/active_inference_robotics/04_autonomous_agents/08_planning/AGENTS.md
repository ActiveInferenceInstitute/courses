# Station: Planning (Autonomous Agents)
...
- **Topics**: PDDL, task planning, contingency planning, risk-aware navigation, full autonomy requirements
...
1. Frame autonomous planning as a system that operates without human intervention, using Active Inference to handle uncertainty, novelty, and failures.
...
5. Connect theoretical Active Inference concepts to practical autonomous planning implementation with specific code patterns and architectural decisions.
