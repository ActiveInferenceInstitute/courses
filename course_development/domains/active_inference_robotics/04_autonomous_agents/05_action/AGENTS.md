# Station: Action (Autonomous Agents)
...
- **Topics**: grasp planning, whole-body control, locomotion over terrain, full autonomy requirements
...
1. Frame autonomous action as a system that operates without human intervention, using Active Inference to handle uncertainty, novelty, and failures.
...
5. Connect theoretical Active Inference concepts to practical autonomous action implementation with specific code patterns and architectural decisions.
