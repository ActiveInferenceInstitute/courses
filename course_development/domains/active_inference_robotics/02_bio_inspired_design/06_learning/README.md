...
| [lab.md](./lab.md) | Lab: Adaptive Robotics and Online Learning |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Implement** online parameter adaptation
2. **Analyze** sim-to-real transfer challenges
3. **Design** a lifelong learning architecture
