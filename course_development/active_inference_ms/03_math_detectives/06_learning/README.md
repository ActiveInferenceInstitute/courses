...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Level Up: How We Learn) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Level Up: How We Learn |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Explain** learning as model updating
2. **Describe** how repetition changes the brain
3. **Apply** learning concepts to study habits
