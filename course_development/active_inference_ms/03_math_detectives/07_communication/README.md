...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Connected: Social Brains) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Connected: Social Brains |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Explain** how we model other minds
2. **Describe** cultural knowledge transfer
3. **Identify** examples of social inference
