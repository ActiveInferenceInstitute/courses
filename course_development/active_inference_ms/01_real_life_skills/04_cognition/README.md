...
| File | Description |
| --- | --- |
| [module.md](./module.md) | Full lecture (Thinking Fast and Slow) |
| [questions.md](./questions.md) | 20 Study Questions |
| [practice_quiz.md](./practice_quiz.md) | Practice Quiz (MC + Short Answer) |
| [lab.md](./lab.md) | Lab: Thinking Fast and Slow |
| [dashboard.html](./dashboard.html) | Interactive Dashboard |

## Learning Goals

1. **Explain** belief updating
2. **Describe** fast vs slow thinking
3. **Apply** inference to a mystery scenario
