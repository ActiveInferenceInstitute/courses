#!/usr/bin/env bash
# Audit script for Active Inference for Middle School
...
echo "=== Active Inference for Middle School Audit ==="
echo ""
...
check_course "01_real_life_skills" "Real Life Skills"
check_course "02_body_science" "Body Science"
check_course "03_math_detectives" "Math Detectives"
check_course "04_code_create" "Code & Create"
