...
def translate_youtube(playlist_name: str, lang: str, dry_run: bool, model: str = None, output_base: Path = None):
    ...
    for playlist in playlists:
        ...
        for video_dir in playlist.iterdir():
            ...
            if target_video_dir.exists():
                ...
                shutil.copytree(video_dir, target_video_dir, dirs_exist_ok=True,
...
def parse_args():
    ...
    parser.add_argument("--output", type=Path, help="Output directory base (default: published/translations)")
