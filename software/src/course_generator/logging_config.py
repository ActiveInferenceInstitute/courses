"""Logging configuration for course generator operations."""
...
def setup_logging(
    ...
    """Set up logging configuration for course generation.
    ...
    log_file = log_dir / f"course_generator_{timestamp}.log"
    ...
    logger.info(
        f"Logging initialized - Console: {logging.getLevelName(log_level)}, "
...
def get_logger(name: str = "course_generator") -> logging.Logger:
    """Get a logger instance for the course generator module.

    Args:
        name: Logger name (default: 'course_generator').
