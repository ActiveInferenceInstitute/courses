...
class TestGenerateDashboards:
    ...
    def test_parse_args(self, script, course_structure):
        args = script.parse_args(["--base", str(course_structure), "--course", "ai-philosophy", "--dry-run"])
    ...
    def test_main_dry_run(self, script, course_structure, capsys):
        ...
        db_path = course_structure / "active_inference" / "01_philosophy" / "01_intro" / "dashboard.html"
    ...
    def test_course_filter(self, script, course_structure, capsys):
        ...
        script.main(["--base", str(course_structure), "--course", "ai-philosophy", "--dry-run", "--include-core"])
